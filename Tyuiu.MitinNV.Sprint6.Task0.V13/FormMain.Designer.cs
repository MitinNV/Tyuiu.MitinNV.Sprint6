...
partial class FormMain
{
    ...
    private void InitializeComponent()
    {
        ...
        groupResultBox_MNV.Location = new Point(163, 318);
        groupResultBox_MNV.Name = "groupResultBox_MNV";
        groupResultBox_MNV.Size = new Size(147, 65);
        ...
        labelResult_MNV.Size = new Size(43, 20);
        labelResult_MNV.TabIndex = 0;
        labelResult_MNV.Text = "y = ...";
        labelResult_MNV.TextAlign = ContentAlignment.MiddleRight;
        // 
        // textBoxValueX_MNV
        // 
        textBoxValueX_MNV.Location = new Point(6, 26);
        ...
        groupBoxValueX_MNV.Size = new Size(145, 66);
        groupBoxValueX_MNV.TabIndex = 3;
        groupBoxValueX_MNV.TabStop = false;
        groupBoxValueX_MNV.Text = "Введите X";
        ...
        pictureBoxFormula_MNV.Location = new Point(635, 26);
        pictureBoxFormula_MNV.Name = "pictureBoxFormula_MNV";
        pictureBoxFormula_MNV.Size = new Size(121, 65);
        ...
        labelCond_MNV.Size = new Size(257, 20);
        labelCond_MNV.TabIndex = 6;
        labelCond_MNV.Text = "Вычислить выражение по формуле";
        // 
        // FormMain
        // 
